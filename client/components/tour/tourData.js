export const tour = [
    ...
    //             marginLeft: 250,
    //             marginTop: 50,
    //             message: "On the home page you can browse all of the recipes on Ediblio. While logged in, hovering your mouse over a recipe will open its toolbar. Here you can add the recipe to your grocery list or add it to one of your collections. Clicking on a recipe here will take you to that recipe's page and show you more details."
    //         },
    //     ]
    // },
    // {
    ...
    //             elementIndex: 1,
    //             highlightIndex: 1,
    //             message: "Collections provide an easy way to group common recipes however way you'd like. You can create your own collections or follow others' collections. Every user starts out with a 'Favorites' collection to get them started.",
    //             marginTop: -50,
    //             marginLeft: 150,
    //         }
    //     ]
